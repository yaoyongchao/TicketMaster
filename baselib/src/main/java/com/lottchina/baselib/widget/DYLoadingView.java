...
public class DYLoadingView extends View {
    ...
    public DYLoadingView(Context context, AttributeSet attrs, int defStyle) {
        ...
        listColor.add(getResources().getColor(R.color.bg_toolbar));
        ta.recycle();
...
//        paint2.setColor(color2);
        paint1.setColor(listColor.get(0));
        paint2.setColor(listColor.get(1));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getMeasuredWidth() / 2.0f - 10 < rtlX && rtlX < getMeasuredWidth() / 2.0f + 10) {
            if (ltrPaint.getColor() == listColor.get(0) && rtlPaint.getColor() == listColor.get(1)) {
                rtlPaint.setColor(listColor.get(2));
            } else if (ltrPaint.getColor() == listColor.get(2) && rtlPaint.getColor() == listColor.get(0)) {
                rtlPaint.setColor(listColor.get(1));
            } else if (ltrPaint.getColor() == listColor.get(1) && rtlPaint.getColor() == listColor.get(2)) {
                rtlPaint.setColor(listColor.get(0));
            }
        }
